...
switch ($options[xPDOTransport::PACKAGE_ACTION]) {
    ...
    case xPDOTransport::ACTION_UPGRADE:
        ...
        $cacheManager->deleteTree(MODX_ASSETS_PATH . 'components/modforms/vendor/',
        ...
        $vendors = array(
            array(
                'validation',
                'validation',
                'http://jqueryvalidation.org/files/jquery-validation-1.15.0.zip',
                MODX_ASSETS_PATH . 'components/modforms/vendor/validation/'
            ),
            array(
                'form',
                'form',
            ...
            array(
                'inputmask',
                'inputmask',
                'https://github.com/RobinHerbots/jquery.inputmask/archive/3.x.zip',
                MODX_ASSETS_PATH . 'components/modforms/vendor/'
            ),
            array(
                'uikit',
